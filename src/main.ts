...
function renderHelp() {
	return [
		...
		"  list update [<board>] <list> [--title <title>] [--new-card-placement top|bottom]",
		"  list reorder [<board>] --lists <list,list,...>",
		"  list setup [<board>] [--preset planning|kanban]",
		"  list archive [<board>] <list> --force",
		"  list delete [<board>] <list> --force",
